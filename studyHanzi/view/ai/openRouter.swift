...
//  studyHanzi
//
//  Created by nguyen xuan hong on 4/1/25.
//
...
//            llmAccounts: openRouterSettings.llmAccounts.randomElement(),
//            modelUrl: openRouterSettings.llmUrl,
...
class openRouterService {
    private let streamService = openRouterStream()
